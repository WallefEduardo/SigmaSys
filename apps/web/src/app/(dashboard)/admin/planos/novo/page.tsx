		...
		<div className="space-y-6">
			<div className="flex items-center justify-between">
				<div className="flex items-center gap-4">
					...
					<div>
						<h1 className="font-bold text-3xl">Novo Plano</h1>
			...
			<form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
				...
				<Card className="border-l-4 border-l-primary">
					...
					<CardContent>
						<div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
							...
							<div className="space-y-2">
								<Label htmlFor="maxQuotes">
									Máximo de Orçamentos por Mês *
								</Label>
								<Input
									id="maxQuotes"
									type="number"
				...
				<div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
					...
					<Card className="border-l-4 border-l-secondary">
						...
						<CardContent className="space-y-4">
							<div className="flex items-center justify-between rounded-lg bg-muted/50 p-3">
								<Label htmlFor="dashboardBasico" className="cursor-pointer">
									Dashboard Básico
								</Label>
								<Switch
									id="dashboardBasico"
									...
									onCheckedChange={(checked) =>
										setValue("dashboardBasico", checked)
									}
								/>
							</div>
							<div className="flex items-center justify-between rounded-lg bg-muted/50 p-3">
								<Label htmlFor="dashboardCompleto" className="cursor-pointer">
									Dashboard Completo
								</Label>
								<Switch
									...
									onCheckedChange={(checked) =>
										setValue("dashboardCompleto", checked)
									}
								/>
							</div>
							<div className="flex items-center justify-between rounded-lg bg-muted/50 p-3">
								<Label htmlFor="dashboardAvancado" className="cursor-pointer">
									Dashboard Avançado
								</Label>
								<Switch
									...
									onCheckedChange={(checked) =>
										setValue("dashboardAvancado", checked)
									}
								/>
							</div>
							<div className="flex items-center justify-between rounded-lg bg-muted/50 p-3">
								<Label htmlFor="dashboardExecutivo" className="cursor-pointer">
									Dashboard Executivo
								</Label>
								<Switch
									...
									onCheckedChange={(checked) =>
										setValue("dashboardExecutivo", checked)
									}
								/>
							</div>
							<div className="flex items-center justify-between rounded-lg bg-muted/50 p-3">
								<Label htmlFor="cadastroClientes" className="cursor-pointer">
								...
								<Switch
									...
									onCheckedChange={(checked) =>
										setValue("cadastroClientes", checked)
									}
								/>
							</div>
							<div className="flex items-center justify-between rounded-lg bg-muted/50 p-3">
								<Label htmlFor="cadastroProdutos" className="cursor-pointer">
								...
								<Switch
									...
									onCheckedChange={(checked) =>
										setValue("cadastroProdutos", checked)
									}
								/>
							</div>
						</CardContent>
					...
					<Card className="border-l-4 border-l-primary">
						...
						<CardContent className="space-y-4">
							<div className="flex items-center justify-between rounded-lg bg-muted/50 p-3">
								<Label htmlFor="moduloDashboard" className="cursor-pointer">
									Dashboard
								</Label>
								<Switch
									id="moduloDashboard"
									...
									onCheckedChange={(checked) =>
										setValue("moduloDashboard", checked)
									}
								/>
							</div>
							<div className="flex items-center justify-between rounded-lg bg-muted/50 p-3">
								<Label htmlFor="moduloCadastros" className="cursor-pointer">
									Cadastros
								</Label>
								<Switch
									id="moduloCadastros"
									...
									onCheckedChange={(checked) =>
										setValue("moduloCadastros", checked)
									}
								/>
							</div>
							<div className="flex items-center justify-between rounded-lg bg-muted/50 p-3">
								<Label htmlFor="moduloComercial" className="cursor-pointer">
									Comercial
								</Label>
								<Switch
									id="moduloComercial"
									...
									onCheckedChange={(checked) =>
										setValue("moduloComercial", checked)
									}
								/>
							</div>
							<div className="flex items-center justify-between rounded-lg bg-muted/50 p-3">
								<Label
									htmlFor="moduloComercialBasico"
								...
								<Switch
									...
									onCheckedChange={(checked) =>
										setValue("moduloComercialBasico", checked)
									}
								/>
							</div>
							<div className="flex items-center justify-between rounded-lg bg-muted/50 p-3">
								<Label htmlFor="moduloEstoque" className="cursor-pointer">
									Estoque
								</Label>
								<Switch
									id="moduloEstoque"
									...
									onCheckedChange={(checked) =>
										setValue("moduloEstoque", checked)
									}
								/>
							</div>
							<div className="flex items-center justify-between rounded-lg bg-muted/50 p-3">
								<Label htmlFor="moduloFinanceiro" className="cursor-pointer">
									Financeiro
								</Label>
								<Switch
									id="moduloFinanceiro"
									...
									onCheckedChange={(checked) =>
										setValue("moduloFinanceiro", checked)
									}
								/>
							</div>
						</CardContent>
