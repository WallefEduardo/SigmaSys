...
import { ArrowLeft, Building2, Save, Shield, User } from "lucide-react";
		...
		<div className="space-y-8">
			...
			<div className="flex items-center justify-between">
				<div className="flex items-center gap-4">
					...
					<div>
						<h1 className="font-bold text-3xl">Editar Usuário</h1>
						<p className="text-muted-foreground">Editando: {user.name}</p>
					</div>
				</div>
			</div>
