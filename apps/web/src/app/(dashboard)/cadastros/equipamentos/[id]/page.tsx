...
export default function EquipamentoPage() {
  ...
  const { data: equipment, isLoading, error } = api.equipments.getById.useQuery({
    id: equipmentId,
  });
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Button 
            onClick={() => router.push(`/cadastros/equipamentos/${equipmentId}/editar`)}
          >
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <div className="flex justify-between">
              ...
              <span className="font-medium">{getTypeLabel(equipment.type)}</span>
            </div>
            <div className="flex justify-between">
