...
export default function NewConsumablePage() {
  ...
  const handleSpecSelect = (spec: {
    ...
    toast.success(`Especificações do ${spec.model} aplicadas! Vida útil: ${(spec.lifespanM2 / 1000).toFixed(0)}K m² • Custo por m²: R$ ${spec.costPerM2.toFixed(4)}`);
  };
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  {watchedType === "printHead" && (
                    <div className="flex items-center gap-2 px-3 py-2 bg-green-50 dark:bg-green-950/20 rounded-lg border">
                              ...
                              <FormLabel className="flex items-center gap-2">
                                ...
                                <Tooltip>
                                  ...
                                  <TooltipContent className="max-w-xs">
                                    <div className="space-y-2 text-xs">
                                      <p><strong>Quantos m² a cabeça imprime antes da troca:</strong></p>
                                      ...
                                      <p className="mt-2"><strong>Como descobrir:</strong> Consulte o banco de especificações técnicas acima!</p>
                                    </div>
                                  </TooltipContent>
                                </Tooltip>
                              </FormLabel>
                          ...
                          <div className="flex items-center justify-between">
                            <div>
                              ...
                              <div className="text-xs text-green-700 dark:text-green-300">
                                R$ {form.watch("cost")} ÷ {form.watch("lifespanM2")?.toLocaleString()} m²
                              </div>
                            </div>
                            <div className="text-lg font-bold text-green-600">
                              R$ {(form.watch("cost") / form.watch("lifespanM2")).toFixed(4)}
                            </div>
                          </div>
                        </div>
                      )}
                        ...
                        <CardContent className="p-4">
                          ...
                          <div className="text-xs text-blue-800 dark:text-blue-200 space-y-2">
                            <div className="p-3 bg-blue-100 dark:bg-blue-900/50 rounded">
                              ...
                              <p>Custo por m² = Custo da cabeça ÷ Vida útil total em m²</p>
                            </div>
                            <div className="p-3 bg-green-100 dark:bg-green-900/50 rounded">
                              <p className="font-medium">✅ Mais fácil:</p>
                              <p>Apenas 2 campos: modelo + quantos m² a cabeça imprime na vida útil</p>
                            </div>
                          </div>
                        </CardContent>
                      </Card>
