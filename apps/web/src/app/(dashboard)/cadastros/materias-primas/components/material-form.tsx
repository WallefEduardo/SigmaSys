...
import { Material, getMaterialCategories } from '@/lib/mock-data/materials'
import { mockUnits, getUnitsByCategory } from '@/lib/mock-data/units'
...
export function MaterialForm({ material, onSubmit, isLoading }: MaterialFormProps) {
  ...
  const handleSubmit = (values: z.infer<typeof formSchema>) => {
    const formData = {
      ...
      minStock: values.minStock ? parseFloat(values.minStock) : undefined,
      ...
      dimensions: {
        ...
        thickness: values.thickness ? parseFloat(values.thickness) : undefined,
      },
      tags,
    }
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="md:col-span-2">
                        ...
                        <FormControl>
                          <Input placeholder="Ex: Vinil Adesivo Branco" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Ex: Materiais Gráficos LTDA" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Código no catálogo do fornecedor" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Ex: Estoque A - Prateleira 1" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
