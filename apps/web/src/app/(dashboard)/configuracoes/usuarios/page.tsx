...
import { Search, Plus, MoreHorizontal, Users, Shield, Activity, Settings } from "lucide-react"
...
import { roleLabels, roleColors, mockPermissions } from "@/lib/mock-data/users"
  ...
  return (
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      <div className="flex items-center justify-between space-y-2">
        <h2 className="text-3xl font-bold tracking-tight">Gestão de Usuários da Empresa</h2>
        ...
        <DialogContent className="sm:max-w-[600px] max-h-[80vh] overflow-y-auto">
          ...
          <div className="py-4">
            <div className="space-y-4">
              {Object.entries(
                mockPermissions.reduce((groups, permission) => {
                      ...
                      {permissions.map((permission) => (
                        <div key={permission.id} className="flex items-center space-x-2">
                          <input
                            type="checkbox"
                            id={permission.id}
                            defaultChecked={editingPermissions?.permissions?.includes(permission.id)}
                          />
                          <label 
