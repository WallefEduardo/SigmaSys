...
export function EquipmentTabs({
	...
	const TabTriggerWithBadge = ({
		...
		return (
			<TabsTrigger
				value={value}
				className="flex min-w-[120px] flex-col items-center gap-1 px-6 py-3 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground"
			>
		...
		<div className="w-full">
			<Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
				<div className="overflow-x-auto border-b">
					<TabsList className="h-auto w-full min-w-max justify-start bg-transparent p-0">
						<TabTriggerWithBadge
							value="basic"
							icon={Settings}
							label="Dados Gerais"
									...
									<CardHeader>
										<div className="flex items-center gap-2">
											...
											<div>
												...
												<CardDescription>
													Configure as diferentes qualidades de impressão e seus
													custos
												</CardDescription>
											</div>
										</div>
