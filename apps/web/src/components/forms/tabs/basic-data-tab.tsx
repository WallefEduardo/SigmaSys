...
export const BasicDataTab = React.memo(function BasicDataTab({
	form,
}: BasicDataTabProps) {
	const {
		register,
		...
		<TooltipProvider>
			<div className="space-y-6">
				...
				<div className="grid gap-6 md:grid-cols-2">
					...
					<div className="space-y-2">
						...
						<Select
							value={watch("type")}
							onValueChange={(value) =>
								setValue("type", value as "printing" | "machining", {
									shouldValidate: true,
									shouldDirty: true,
								})
							}
				...
				<div className="space-y-4">
					<div className="space-y-2">
						...
						<p className="text-muted-foreground text-sm">
							Estes custos são usados para{" "}
							<strong>calcular automaticamente</strong> o custo final por{" "}
							{watchedType === "printing" ? "m²" : "hora"}
						</p>
					</div>
						...
						<div className="space-y-2">
							...
							{errors.energyCostPerHour && (
								<p className="text-destructive text-sm">
									{errors.energyCostPerHour.message}
								</p>
							)}
						</div>
				...
				<div className="space-y-4">
					...
					<div
						className={`grid gap-6 ${watchedType === "printing" ? "md:grid-cols-1" : "md:grid-cols-3"}`}
					>
						<div className="space-y-2">
							<LabelWithTooltip
								htmlFor="maxWidth"
