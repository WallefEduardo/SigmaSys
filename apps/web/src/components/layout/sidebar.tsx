	...
	},
	{
		...
		children: [
			...
			},
			{
				...
				icon: BarChart3,
				href: "/financeiro/ponto-equilibrio",
			},
		],
	},
	{
	...
	const SidebarContent = () => (
		<div className="flex h-full flex-col">
			...
			<div className="flex h-16 items-center justify-between border-b px-4">
				{!isCollapsed && <h2 className="font-semibold text-lg">ERP System</h2>}
				<Button
					variant="ghost"
					size="icon"
												...
												{item.children.map((child) => (
													<Button
														...
														className={cn(
															...
															pathname === child.href &&
																"border-secondary border-r-2 bg-secondary/10 text-secondary",
														)}
													>
