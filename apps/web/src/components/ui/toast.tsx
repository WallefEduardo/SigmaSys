	...
	(
		...
		return (
			<div
				ref={ref}
				className={cn(
					"group slide-in-from-top-2 pointer-events-auto relative flex w-full max-w-md animate-in items-center justify-between space-x-4 overflow-hidden rounded-md border p-4 shadow-lg transition-all",
					{
