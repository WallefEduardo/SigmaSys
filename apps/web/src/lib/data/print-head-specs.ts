 ...
 */
export function getPrintHeadsByManufacturer(
	manufacturer: string,
): PrintHeadSpec[] {
	return POPULAR_PRINT_HEADS.filter(
		(head) => head.manufacturer.toLowerCase() === manufacturer.toLowerCase(),
	);
}
 ...
 */
export function getPrintHeadsByApplication(
	application: string,
): PrintHeadSpec[] {
