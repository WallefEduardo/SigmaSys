...
export class FormulaEngine {
  ...
  static evaluate(formula: string, variables: FormulaVariables): number {
    try {
      ...
      const processedFormula = this.processFormula(sanitizedFormula, variables);
   ...
   */
  private static processFormula(formula: string, variables: FormulaVariables): string {
 ...
 */
export const getRulesByCategory = (category: 'AREA' | 'LENGTH' | 'UNIT'): PredefinedRule[] => {
