...
export async function seedPlans() {
  ...
  const enterprisePlan = await prisma.plan.upsert({
    ...
    create: {
      name: 'Enterprise',
      description: 'Solução completa para grandes empresas com todos os recursos',
      price: 199.90,
      yearlyPrice: 1999.00, // 10 meses
      currency: 'BRL',
  ...
  const superAdminPlan = await prisma.plan.upsert({
    ...
    create: {
      name: 'Super Admin',
      description: 'Plano especial para superadmins gerenciarem múltiplas empresas',
