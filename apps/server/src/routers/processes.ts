...
export const processesRouter = router({
  ...
  stats: protectedProcedure
    ...
    .query(async ({ ctx }) => {
      ...
      return {
        ...
        processesBySector: processesBySector.map(p => ({ sector: p.sector, count: p._count })),
        processesByTimeUnit: processesByTimeUnit.map(p => ({ timeUnit: p.timeUnit, count: p._count })),
  ...
  getTimeUnits: protectedProcedure
    .query(() => {
      return [
