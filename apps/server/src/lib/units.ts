...
export const defaultUnits: Unit[] = [
	...
	{
		id: "perimetro_total",
		name: "Perímetro Total",
		symbol: "ptot",
		category: "length",
		formula: "2 * largura + 2 * altura + 2 * espessura",
	},

	// Metro Linear específicos
	{
		id: "ml_largura",
		name: "Metro Linear Largura",
		symbol: "ml_l",
		category: "length",
		formula: "largura",
	},
	...
	{
		id: "ml_travas",
		name: "Metro Linear Travas",
		symbol: "ml_t",
		category: "length",
		formula: "altura / espacamento_travas",
	},
	{
		id: "ml_travas_altura",
		name: "Metro Linear Travas Altura",
		symbol: "ml_ta",
		category: "length",
		formula: "altura",
	},
	...
	{
		id: "m2_largura_altura",
		name: "Metro Quadrado (L x A)",
		symbol: "m²_la",
		category: "area",
		formula: "largura * altura",
	},
	{
		id: "m2_largura_espessura",
		name: "Metro Quadrado (L x E)",
		symbol: "m²_le",
		category: "area",
		formula: "largura * espessura",
	},
	{
		id: "m2_altura_espessura",
		name: "Metro Quadrado (A x E)",
		symbol: "m²_ae",
		category: "area",
		formula: "altura * espessura",
	},
...
export class UnitsService {
	...
	static async getUnitsByCategory(category: string): Promise<Unit[]> {
		...
		return await CacheService.getOrSet(
			cacheKey,
			async () => defaultUnits.filter((unit) => unit.category === category),
			CacheTTL.UNITS,
		);
	}
